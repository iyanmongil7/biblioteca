...
<form enctype="multipart/form-data" class="w-full max-w-lg border-4" method="POST" action="{{ $route }}">
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
        ...
        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold" for="año">
            ...
            <input value="{{ $libro->unidades }}" name="unidades" size="30"  placeholder="introduzca unidades" class="form-control no-resize appearance-none block w-full bg-gray-300 text-gray-700 border border-gray-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-48 resize-none" id="año"></input>
