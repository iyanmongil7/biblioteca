        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-center p-2 ">
                <form class="row  input-group sombra mx-5 col-3 text-center" id="buscador">
                    ...
                    <button class="btn btn-primary boton col-2 input-group-btn" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search ml-2" viewBox="0 0 16 16">
